...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($photo->process_user($user_id)) {
            $session->msg('s', 'Фото обновлено успешно!');
    ...
    if (isset($_POST['update'])) {
        ...
        if (empty($errors)) {
            ...
            if ($result && $db->affected_rows() === 1) {
                $session->msg('s', "Аккаунт обновлен! ");
                redirect('edit_account.php', false);
            } else {
                $session->msg('d', ' Извините, обновление не удалось!');
                redirect('edit_account.php', false);
            }
        } else {
                    ...
                    <div class="col-md-8">
                        <form class="form" action="edit_account.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" name="submit" class="btn btn-warning">Изменить</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="col-md-6">
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                ...
                <span>Изменить мой аккаунт</span>
            </div>
            <div class="panel-body">
                <form method="post" action="edit_account.php?id=<?php echo (int)$user['id']; ?>" class="clearfix">
                    ...
                    <div class="form-group clearfix">
                        <a href="change_password.php" title="change password" class="btn btn-danger pull-right">Изменить пароль</a>
