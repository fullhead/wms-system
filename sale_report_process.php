...
<?php if ($results): ?>
    <div class="page-break">
        <div class="sale-head">
            <h1>WMS-система - Отчеты о продажах</h1>
            <strong><?php if (isset($start_date)) {
                    echo $start_date;
                } ?> по <?php if (isset($end_date)) {
                    echo $end_date;
                } ?> </strong>
        </div>
...
<?php
    ...
    $session->msg("d", "Продажи не найдены!");
    redirect('sales_report.php', false);
endif;
?>
</body>
