<?php
    $page_title = 'Редактировать продажи';
...
<?php
    ...
    if (!$sale) {
        $session->msg("d", "Отсутствует идентификатор продукта.");
        redirect('sales.php');
    }
?>
    ...
    if (isset($_POST['update_sale'])) {
        ...
        if (empty($errors)) {
            ...
            if ($result && $db->affected_rows() === 1) {
                ...
                $session->msg('s', "Продажа обновлена.");
                redirect('edit_sale.php?id=' . $sale['id'], false);
            } else {
                $session->msg('d', ' Извините, не удалось обновить!');
        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <strong>
                    ...
                    <span>Редактировать продажи</span>
                </strong>
                <div class="pull-right">
                    <a href="sales.php" class="btn btn-primary">Показать все продажи</a>
                </div>
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                            ...
                            <td>
                                <button type="submit" name="update_sale" class="btn btn-primary">Обновить</button>
                            </td>
                        </form>
                    </tr>
                    </tbody>
