    ...
    if (isset($_POST['product'])) {
        ...
        if (empty($errors)) {
            ...
            if ($result && $db->affected_rows() === 1) {
                $session->msg('s', "Товар успешно обновлен ");
                redirect('product.php', false);
            } else {
                $session->msg('d', ' Ошибка при обновление товара!');
                ...
                <form method="post" action="edit_product.php?id=<?php echo (int)$product['id'] ?>">
                  ...
                  <span class="input-group-addon">
                   <i class="glyphicon glyphicon-th-large"></i>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="product-photo">
                                    <option value="">Выберите фотографию товара</option>
                    ...
                    <div class="form-group">
                      ...
                      <span class="input-group-addon">
                       <i class="glyphicon glyphicon-shopping-cart"></i>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="qty">Цена покупки</label>
                                    <div class="input-group">
                      <span class="input-group-addon">
                        <i class="glyphicon glyphicon-rub"></i>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="qty">Цена продажи</label>
                                    <div class="input-group">
                       <span class="input-group-addon">
                         <i class="glyphicon glyphicon-rub"></i>
                       </span>
                    ...
                    <button type="submit" name="product" class="btn btn-danger">Обновить</button>
                </form>
            </div>
        </div>
    </div>
