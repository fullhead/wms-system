...
<?php
    if (isset($_POST['add_product'])) {
        ...
        if (empty($errors)) {
            ...
            if ($db->query($query)) {
                $session->msg('s', "Товар добавлен!");
                redirect('add_product.php', false);
            } else {
                $session->msg('d', ' Извините, возникла проблема при добавлении товара!');
                   ...
                   <i class="glyphicon glyphicon-th-large"></i>
                     ...
                     <span class="input-group-addon">
                      ...
                      <span class="input-group-addon">
                        ...
                        <button type="submit" name="add_product" class="btn btn-danger">Добавить товар</button>
                    </form>
                </div>
            </div>
        </div>
